...
export default function AllCompanies() {
    ...
    return (
        <div className="min-h-screen m-3 py-10 sm:m-0 sm:px-10">
                    ...
                    companies.map((company) => (
                        ...
                        >
                            ...
                            <div className="mt-6">
                                ...
                                <span
                                    className={`rounded-full px-3 py-1 text-xs font-semibold capitalize ${company.verificationStatus === "Verified"
